...
mean = pd.DataFrame(df_cleaned.groupby(["Strain", "Treatment", "Time_hrs"])["Optical_Density_600nm"].mean().reset_index())
std = pd.DataFrame(df_cleaned.groupby(["Strain", "Treatment", "Time_hrs"])["Optical_Density_600nm"].std().reset_index())
